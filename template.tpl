...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Opticks Conversion Tag",
  "categories": [
    "AFFILIATE_MARKETING",
    "ADVERTISING",
    "MARKETING",
  ...
  "description": "Tag for conversion reporting for Opticks invalid traffic detection and ad-fraud solution.",
  "containerContexts": [
    "WEB"
  ]
}
...
var c = getCookieValues('opticksid');
var s = (c && c[0]) || '';
var h = copyFromWindow('optHitId') || '';

if (s || h) {
  var url = "https://opticksstatic.com/conversion?s=" + encodeUriComponent(s) + "&h=" + encodeUriComponent(h);
  if (data.macros) {
...
Created on 7/28/2022, 2:30:41 PM
